#ifndef JSONREPLYTITLES_H
#define JSONREPLYTITLES_H

#include "JsonReplyAbstract.h"

class JsonReplyTitles : public JsonReplyAbstract
{
public:
    static const QString PROMPT;
    JsonReplyTitles(const QString &workingDir
