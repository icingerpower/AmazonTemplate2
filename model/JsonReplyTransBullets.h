#ifndef JSONREPLYTRANSBULLETS_H
#define JSONREPLYTRANSBULLETS_H

#include "JsonReplyAbstract.h"

class JsonReplyTransBullets : public JsonReplyAbstract
{
public:
    static const QString PROMPT;
    JsonReplyTransBullets(
